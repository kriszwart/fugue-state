...
export default function LoginPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // Redirect based on role and initialization status
      if (initData.isJudge) {
        // Judges go to judge dashboard
        router.push('/judge-dashboard')
      } else if (initData.needsInitialization || !initData.isInitialized) {
        // Redirect to initialization if not completed
        router.push('/initialization')
      } else {
        // Redirect to workspace if already initialized
    ...
    <div className="min-h-screen bg-[#09090b] flex items-center justify-center p-6">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-serif-custom italic text-3xl text-zinc-100 mb-2">Enter the Fugue</h1>
